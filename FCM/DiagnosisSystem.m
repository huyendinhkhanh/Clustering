...
% Last Modified by GUIDE v2.5 16-May-2017 10:41:50
...
% set(handles.epsilon, 'visible', 'off');
...
max_iter = get(handles.max_iter,'UserData');
...
set(handles.btn_segment, 'enable', 'off');
waitbar(0.25);
[image_out]=test_fcm(IM,epsilon,numClust,max_iter);
waitbar(0.5);
%pause(1);
% handles.C = C;
% handles.U = U;
handles.numClust = numClust;
handles.IM = IM;
...
if filename ~= 0
    ...
    set(handles.num_of_clust,'UserData', 0);
    
    set(handles.num_of_clust,'string', '0');
    set(handles.epsilon,'string', '0');
    set(handles.max_iter,'string', '0');
